<?php
include('C:\xampp\htdocs\ydf-system-oshen\app\controllers\accounting\Invoices\UK\InvoicesDiscountDetailsControllerUK.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Shipping Discount Table UK</title>
    <!-- Bootstrap -->
...
<body class="bg-light">
    <div class="container mt-5">
        <h2 class="text-center text-primary fw-bold mb-4">Shipping Discount Table UK</h2>
        <div class="mb-3">
