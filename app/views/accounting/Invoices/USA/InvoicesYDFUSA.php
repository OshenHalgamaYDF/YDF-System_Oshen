<?php
include('C:\xampp\htdocs\ydf-system-oshen\app\controllers\accounting\Invoices\USA\InvoicesControllerYDFUSA.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center mt-4 text-primary fw-bold">Invoices Generator - USA</h1>
        <div class="d-flexs align-items-left mt-4">
            ...
            <button class="btn btn-secondary md-2" onclick="window.location.href='Invoices_discount_tableUSA.php'">
